...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiDocumentation.CorrespondenceDetails();
  });
  ...
  describe('CorrespondenceDetails', function() {
    it('should create an instance of CorrespondenceDetails', function() {
      // uncomment below and update the code to test CorrespondenceDetails
      //var instane = new ApiDocumentation.CorrespondenceDetails();
      //expect(instance).to.be.a(ApiDocumentation.CorrespondenceDetails);
    });
